    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-flat" data-widget="treeview" role="menu" data-accordion="false" id="navigationMenu">
          ...
          <li class="nav-item">
            <a href="{{ route('users.index') }}" class="nav-link @if(Request::routeIs('students.index') || Request::routeIs('students.create') || Request::routeIs('students.edit') || Request::routeIs('students.show')) active @endif">

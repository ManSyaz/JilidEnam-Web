        ...
        <div class="overlay-form">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="custname" type="text" class="form-control @error('custname') is-invalid @enderror" name="custname" value="{{ old('custname') }}" required autocomplete="name" autofocus placeholder="{{ __('Enter your full name') }}">
                    @error('custname')
                ...
                <div class="mb-3">
                    ...
                    <input id="custemail" type="email" class="form-control @error('custemail') is-invalid @enderror" name="custemail" value="{{ old('custemail') }}" required autocomplete="email" placeholder="{{ __('Enter your email address') }}">
                    @error('custemail')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="mb-3">
                    ...
                    <input id="custpassword" type="password" class="form-control @error('custpassword') is-invalid @enderror" name="custpassword" required autocomplete="new-password" placeholder="{{ __('Password must at least 8 characters') }}">
                    @error('custpassword')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="mb-3">
                    ...
                    <input id="custpassword-confirm" type="password" class="form-control" name="custpassword_confirmation" required autocomplete="new-password" placeholder="{{ __('Confirm your password') }}">
                </div>
                <div class="mb-3">
                    <label for="custphone" class="form-label">{{ __('Phone') }}</label>
                    <input id="custphone" type="tel" class="form-control @error('custphone') is-invalid @enderror" name="custphone" required autocomplete="phone" placeholder="{{ __('Enter your phone number') }}">
                    @error('custphone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="mb-3">
                    ...
                    <textarea id="custaddress" class="form-control @error('custaddress') is-invalid @enderror" name="custaddress" required autocomplete="address" placeholder="{{ __('Enter your full address') }}"></textarea>
                    @error('custaddress')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="mb-0">
                    <button type="submit" class="btn bg-danger text-white">{{ __('Register') }}</button>
                </div>
            </form>
        </div>
    </div>
